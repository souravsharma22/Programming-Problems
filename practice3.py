...
def two_pass_assembler(assembly_code):
    ...
    for line in assembly_code:
        ...
        if parts and parts[0] in INSTRUCTION_SET:
            ...
            operand_codes = [
                symbol_table[operand] if operand in symbol_table else operand 
...
# Example assembly code to add two numbers
assembly_code = [
    "START: LDA 10",  # Load first number into accumulator
    "ADD 20",         # Add second number
